...
Dump of assembler code for function main:
   ...
   0x0804853c <+19>:     je     0x8048548 <main+31>                     ; if equal jump to <+31>
   0x0804853e <+21>:     mov    eax,0x1                                 ; else set eax to 1
   0x08048543 <+26>:     jmp    0x8048630 <main+263>                    ; then jump to <+263>
   0x08048548 <+31>:     lea    ebx,[esp+0x50]                          ; load buffer to ebx
   0x0804854c <+35>:     mov    eax,0x0                                 ; eax = 0
   0x08048551 <+40>:     mov    edx,0x13                                ; edx = 19
   0x08048556 <+45>:     mov    edi,ebx                                 ; edi = ebx (buffer)
   ...
   0x080485ab <+130>:    mov    DWORD PTR [esp+0x9c],eax                ; lang = <getenv> return value
   ...
   0x08048630 <+263>:    lea    esp,[ebp-0xc]                           ; load return value to stack
